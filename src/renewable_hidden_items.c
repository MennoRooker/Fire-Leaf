...
static const struct RenewableHiddenItemData sRenewableHiddenItems[] = {
    ...
    },
    {
        ...
        .rare = {
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WACAN_BERRY),
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_SITRUS_BERRY),
            ...
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RINDO_BERRY),
        ...
        .common = {
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_YACHE_BERRY),
            HIDDEN_ID(FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_HABAN_BERRY),
    ...
    },
    {
        ...
        .rare = {
            ...
            HIDDEN_ID(FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_HEART_SCALE),
        ...
        .uncommon = {
            ...
            HIDDEN_ID(FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_BOTTLE_CAP),
            HIDDEN_ID(FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL),
            HIDDEN_ID(FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_HEART_SCALE),
            NO_ITEM,
            NO_ITEM
