...
#define FLAG_HIDE_SAFARI_ZONE_WEST_YELLOW_SHARD                 0x18A
...
#define FLAG_HIDE_POKEMON_MANSION_B1F_GREEN_SHARD               0x1A5
...
#define FLAG_HIDE_VICTORY_ROAD_2F_BLUE_SHARD                    0x1AD
...
#define FLAG_HIDE_THREE_ISLAND_BERRY_FOREST_BOTTLE_CAP          0x1EC
#define FLAG_HIDE_MT_EMBER_EXTERIOR_HEAT_ROCK                   0x1ED
...
#define FLAG_HIDE_FOUR_ISLAND_ICEFALL_CAVE_1F_ICY_ROCK          0x1F1
...
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_YACHE_BERRY             (FLAG_HIDDEN_ITEMS_START +  90)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WACAN_BERRY             (FLAG_HIDDEN_ITEMS_START +  91)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_HABAN_BERRY             (FLAG_HIDDEN_ITEMS_START +  92)
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_SITRUS_BERRY            (FLAG_HIDDEN_ITEMS_START +  93)
...
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RINDO_BERRY             (FLAG_HIDDEN_ITEMS_START + 101)
...
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_BOTTLE_CAP              (FLAG_HIDDEN_ITEMS_START + 106)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_ULTRA_BALL              (FLAG_HIDDEN_ITEMS_START + 107)
#define FLAG_HIDDEN_ITEM_ONE_ISLAND_TREASURE_BEACH_HEART_SCALE             (FLAG_HIDDEN_ITEMS_START + 108)
...
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_CHILAN_BERRY          (FLAG_HIDDEN_ITEMS_START + 171)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_SITRUS_BERRY          (FLAG_HIDDEN_ITEMS_START + 172)
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_OCCA_BERRY            (FLAG_HIDDEN_ITEMS_START + 173)
